...
// Demo.json is our usable abstraction, which we'll use through the code below.
...
window.App = {
  ...
  fetchOwner: function() {
    ...
    Demo.deployed().then(function(instance) {
      ...
      return demoContract.owner.call({from: account});
    }).then(function(owner) {
      console.log("owner-"+owner);
      var ownerDoc = document.getElementById("owner");
      ownerDoc.innerHTML = owner;
    }).catch(function(e) {
      console.log(e);
  ...
  changeOwner: function() {
    ...
    var newOwner = document.getElementById("new_owner");
    ...
    Demo.deployed().then(function(instance) {
      demoContract = instance;
      return demoContract.changeOwner(web3.toAddress(newOwner), {from: account});
    }).then(function() {
